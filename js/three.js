...
THREE.Geometry.prototype = {
    ...
    clone: function () {
        for (
            var a = new THREE.Geometry(), b = this.vertices, c = 0, d = b.length; c < d; c++
        )
...
THREE.BufferGeometry.prototype = {
    ...
    normalizeNormals: function () {
        for (
            var a = this.attributes.normal.array, b, c, d, e = 0, f = a.length; e < f; e += 3
        )
            (b = a[e]),
            (c = a[e + 1]),
            (d = a[e + 2]),
    ...
    computeTangents: function () {
        ...
        if (
            ...
            for (
                var h = this.attributes.tangent.array, i = [], k = [], g = 0; g < f; g++
            )
...
THREE.LOD.prototype.addLevel = function (a, b) {
    void 0 === b && (b = 0);
    for (
        var b = Math.abs(b), c = 0; c < this.LODs.length && !(b < this.LODs[c].visibleAtDistance); c++
    );
        ...
        if (!1 !== d.visible) {
            ...
            if (!d.morphTargets && 0 <= a.position)
                ...
                if (f.morphTargetForcedOrder.length) {
                    ...
                    for (
                        g = f.morphTargetInfluences; h < d.numSupportedMorphTargets && h < i.length;
                    ...
                    for (var c = 0; c < a.hierarchy.length; c++) {
                        ...
                        if (
                            ...
                            for (d = 0; d < a.hierarchy[c].keys.length; d++)
                                for (
                                    var i = 0; i < a.hierarchy[c].keys[d].morphTargets.length; i++
                                ) {
                            ...
                            for (d = 0; d < a.hierarchy[c].keys.length; d++) {
                                ...
                                for (k in h) {
                                    for (
                                        i = 0; i < a.hierarchy[c].keys[d].morphTargets.length; i++
                                    )
